...
%
% For example:https://github.com/DhruvRana2704/Urban_Wave_Overleaf/edit/main/code.tex
...
\usepackage{titling}     % control over title
...
\pretitle{\centering\Huge\bfseries\color{purple}}
\posttitle{\par\vskip 0.5em}

\preauthor{\centering\Large\itshape\color{teal}}
\postauthor{\par\vskip 0.5em}

\predate{\centering\color{gray}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{follower.png}
    \caption{Post Insertion into MongoDB}
    \label{fig:sample}
\end{figure}
...
\end{lstlisting}
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{oldpost_30min.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{nearcord.png}
